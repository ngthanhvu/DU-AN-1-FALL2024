<template>
<footer class="py-5" :style="{ backgroundImage: 'url(https://demo.templatesjungle.com/foodmart/images/background-pattern.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }">    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-6">
          <div class="footer-menu">
            <h5 class="widget-title">Chính Sách & Bảo Mật</h5>
            <ul class="menu-list list-unstyled">
              <li class="menu-item">
                <a href="#" class="nav-link">FAQ</a>
              </li>
